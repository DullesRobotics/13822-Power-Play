...
public class AutonomousFunctions {
    ...
    public static int timeToStrafeNear = 1000, timeToStrafeFar = 1000;
    ...
    public static void parkTime(LinearOpMode op, TeamColor t, FieldPosition position) {
        ...
        long timeToDrive = position == FieldPosition.LONG ? timeToDriveFar + timeToStrafeNear : timeToDriveNear;
