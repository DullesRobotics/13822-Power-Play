...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public Double getExternalHeadingVelocity() {
        ...
        switch(IMU_AXIS){
            case X: return (double) imu.getAngularVelocity().xRotationRate;
            case Y: return (double) imu.getAngularVelocity().yRotationRate;
            default: return (double) imu.getAngularVelocity().zRotationRate;
        }
    }
}
